...
public class BufferedBackgroundInputStream extends InputStream implements BufferedInputStream, Iterable<byte[]> {
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        ...
        System.out.println("^^^ BBIS Count " + count + " (" + off + " - " + len + ")");
        return count;
    }
