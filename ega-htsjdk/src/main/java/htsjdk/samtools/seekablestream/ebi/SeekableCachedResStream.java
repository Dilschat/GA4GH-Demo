 ...
 */
public class SeekableCachedResStream extends SeekableStream {
    ...
    public SeekableCachedResStream(final URL url) {
        this(url, null, null);
    }

    public SeekableCachedResStream(final URL url, String auth) {
        this(url, null, auth);
    }

    public SeekableCachedResStream(final URL url, Proxy proxy) {
        this(url, proxy, null);
    }

    public SeekableCachedResStream(final URL url, Proxy proxy, String auth) {
        this(url, proxy, auth, -1);
    }

    public SeekableCachedResStream(final URL url, Proxy proxy, String auth, long fileSize) {
    ...
    public SeekableCachedResStream setSourceNull(boolean hack) {
        this.hack = hack;
        return this;
    }

    // A hack to fool HTSJDK to recognize the file format based on the extension
    public SeekableCachedResStream setExtension(String hack_extension) {
